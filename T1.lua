...
local SaveSettings = {
    ...
    ["Summon"] = {
        ...
        ['Select Capsule'] = "capsule_halloween2",
...
for i,GAME_MODE in pairs(GAME_MODE) do
    ...
    elseif GAME_MODE == "raid" then
        for i,NameMap in pairs(HalloweenDropdown) do
            if not SaveSettings['Macro']['Macro Map'][GAME_MODE][NameMap] then
                SaveSettings['Macro']['Macro Map'][GAME_MODE][NameMap] = "None"
            end
        ...
        end        for i,NameMap in pairs(HalloweenDropdown) do
            if not SaveSettings['Macro']['Macro Map'][GAME_MODE][NameMap] then
                SaveSettings['Macro']['Macro Map'][GAME_MODE][NameMap] = "None"
            end
    ...
    task.spawn(function()
        while task.wait() do
            if SaveSettings['Summon']['Auto Open Capsule'] then
                local args = {
                    [1] = SaveSettings['Summon']['Select Capsule'],
                    [2] = {
