                ...
                if SaveSettings['Macro']['Play Macro'] and isfile("HolyShz/AnimeAdventures/Macro/" .. tostring(MacroMapSelect)..".json") then
                    ...
                    for i,v in pairs(Macro) do
                        ...
                        if v["Method_Data"]["Method"] == "Place" then
                            ...
                            elseif string.find(v["Method_Data"]["Data"]["UnitPlace"],"metal_knight_evolved") or string.find(v["Method_Data"]["Data"]["UnitPlace"],"elyssia_evolved") then
                                ...
                                if i == 1 then
                                    task.spawn(function()
                                        ...
                                        local args = {
                                            [1] = Table_Equipped_Slot[MacroData["UnitPlace"]]['Unit_uuid'],
                                            [2] = CFrame.new(Vector3.new(CFrame_X, CFrame_Y, CFrame_Z) )
                                        }
                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.spawn_unit:InvokeServer(unpack(args))
                                    end)
                                    return
                                elseif i == 2 then
                                    task.spawn(function()
                                        ...
                                        local args = {
                                            [1] = Table_Equipped_Slot[MacroData["UnitPlace"]]['Unit_uuid'],
                                            [2] = CFrame.new(Vector3.new(CFrame_X - x, CFrame_Y, CFrame_Z) )
                                        }
                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.spawn_unit:InvokeServer(unpack(args))
                                    end)
                                    return
