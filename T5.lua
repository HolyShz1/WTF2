                ...
                if SaveSettings['Macro']['Play Macro'] and isfile("HolyShz/AnimeAdventures/Macro/" .. tostring(MacroMapSelect)..".json") then
                    ...
                    for i,v in pairs(Macro) do
                        ...
                        if v["Method_Data"]["Method"] == "Place" then
                            ...
                            local CFrame_X,CFrame_Y,CFrame_Z = StringToXYZ(MacroData["CFrame"]) 
                            repeat task.wait()
                            ...
                            elseif string.find(MacroData["UnitPlace"],"metal_knight") then
                                local string_1 = Table_Equipped_Slot[MacroData["UnitPlace"]]['Unit_uuid'];
                                local userdata_1 = CFrame.new(CFrame_X, CFrame_Y, CFrame_Z, 1, 0, -0, -0, 1, -0, 0, 0, 1);
                                local Target = game:GetService("ReplicatedStorage").endpoints["client_to_server"]["spawn_unit"];
                                Target:InvokeServer(string_1, userdata_1);
                            elseif string.find(MacroData["UnitPlace"],"elyssia") then
                                local string_1 = Table_Equipped_Slot[MacroData["UnitPlace"]]['Unit_uuid'];
                                local userdata_1 = CFrame.new(CFrame_X, CFrame_Y, CFrame_Z, 1, 0, -0, -0, 1, -0, 0, 0, 1);
                                local Target = game:GetService("ReplicatedStorage").endpoints["client_to_server"]["spawn_unit"];
                                Target:InvokeServer(string_1, userdata_1);
