                ...
                if SaveSettings['Macro']['Play Macro'] and isfile("HolyShz/AnimeAdventures/Macro/" .. tostring(MacroMapSelect)..".json") then
                    ...
                    for i,v in pairs(Macro) do
                        ...
                        if v["Method_Data"]["Method"] == "Place" then
                            ...
                            elseif string.find(v["Method_Data"]["Data"]["UnitPlace"],"metal_knight_evolved") then
                                for i, v in pairs(workspace._UNITS:GetChildren()) do
                                    local _stats = v:FindFirstChild("_stats")
                                    repeat task.wait()
                                        local args = {
                                            [1] = Table_Equipped_Slot[MacroData["UnitPlace"]]['Unit_uuid'],
                                        ...
                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.spawn_unit:InvokeServer(unpack(args))
                                    until _stats:WaitForChild("id").Value == "metal_knight_evolved"
                                end
                            elseif string.find(v["Method_Data"]["Data"]["UnitPlace"],"elyssia_evolved") then
                                for i, v in pairs(workspace._UNITS:GetChildren()) do
                                    local _stats = v:FindFirstChild("_stats")
                                    repeat task.wait()
                                        local args = {
                                        ...
                                        game:GetService("ReplicatedStorage").endpoints.client_to_server.spawn_unit:InvokeServer(unpack(args))
                                    until _stats:WaitForChild("id").Value == "elyssia_evolved"
                                end
                            else
                                local args = {
                                    [1] = Table_Equipped_Slot[MacroData["UnitPlace"]]['Unit_uuid'],
